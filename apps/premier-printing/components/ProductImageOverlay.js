...
const ProductImageOverlay = ({
  ...
  useEffect(() => {
    let getRender = async ()=>{
      ...
      setBase64(`https://simplysage.pythiastechnologies.com/api/renderImages/${style}-${side}.jpg?blank=${style}&blankImage=${styleImage}&side=${side}&colorName=${colorName.value}&design=${designImage}&width=400`)
    }
    getRender()
