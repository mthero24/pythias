...
export default function Admin(){
    return(<Box sx={{padding: "3%"}}>
        <Grid2 container spacing={2}>
            ...
            <Grid2 size={12}>
                <iframe style={{ background: "#FFFFFF", border: "none", borderRadius: "2px", boxShadow: "0 2px 10px 0 rgba(70, 76, 79, .2)", width: "100%", marginTop: "2%" }} width="640" height="480" src="https://charts.mongodb.com/charts-pythias-tech-ckbsbme/embed/charts?id=56f7e4af-6d69-49bb-bc31-a5f4c8ef5540&maxDataAge=3600&theme=light&autoRefresh=true"></iframe>
            </Grid2> 
            <Grid2 size={12}>
                <iframe style={{ background: "#FFFFFF", border: "none", borderRadius: "2px", boxShadow: "0 2px 10px 0 rgba(70, 76, 79, .2)", width: "100%", marginTop: "2%" }} width="640" height="480" src="https://charts.mongodb.com/charts-pythias-tech-ckbsbme/embed/charts?id=448af33a-3695-48cd-9147-6b073c35a668&maxDataAge=3600&theme=light&autoRefresh=true"></iframe>
            </Grid2> 
        </Grid2> 
    </Box>)
}