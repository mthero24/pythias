                                    ...
                                    <Card sx={{width: "100%", padding: "3%", borderRadius: "9px", cursor: "pointer", height: "100%"}}>
                                        <Link href={`/admin/design/${d._id}`} target="_blank">
                                            <Box sx={{ padding: {sm: "3%", md:"6%"}, background: "#e2e2e2", height: { sm: "250px", md: "300px", lg: "350px" }, minHeight: "250px", display: "flex", alignItems: "center", justifyContent: "center" }}>
                                                <img src={d.images && d.images[Object.keys(d.images)[0]] ? `${d.images[Object.keys(d.images)[0]]?.replace("images1.pythiastechnologies.com", "images2.pythiastechnologies.com/origin")}?width=300` : "/missingImage.jpg"} width={150} height={150} alt={`${d.name} ${d.sku} design`} style={{width: "100%", height: "auto", maxHeight: "250px", background: "#e2e2e2"}}/>
                                            </Box>
                                            <hr/>
                                            <Box sx={{padding: "3%"}}>
