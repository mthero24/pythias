...
// PUBLIC — feeds the customer "Design & Send In" blank picker. Returns blanks WITH product images,
// color swatches/images, and sizes (so the picker shows pictures, not codes like "PC54").
