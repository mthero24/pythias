...
// POST /api/storefront/section-fields-ai — AI-rewrite a section's settings (copy/links/colors). Body:
// { type, settings, prompt }. Returns { fields } (a partial settings patch).
