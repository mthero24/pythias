...
export default async function PrintLabels(){
    ...
    return <Main labels={labels} giftLabels={giftMessages} rePulls={rePulls} batches={batches} source={"PP"} printers={sc.labelPrinters} dtfPrinters={sc.dtfPrinters} useShipByDate={useShipByDate} stackInventoryLoc={!!tpl.stackInventoryLoc} />
}