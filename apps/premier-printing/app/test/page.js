...
export default async function Test(){
    ...
    //                 {id: "variant.description", title: "fields.description"},
    ...
    //                     let product = await getSkuAcenda({clientId: process.env.acendaClientIdSS, clientSecret: process.env.acendaClientSecretSS, organization: process.env.acendaOrganizationSS, sku: `${p.design.sku}_${p.blank.blank.code}` })
    //                     let item = await getSkuAcenda({clientId: process.env.acendaClientIdSS, clientSecret: process.env.acendaClientSecretSS, organization: process.env.acendaOrganizationSS, sku: p.variants[0].sku })
    //                     if(item && item[0] && !product){
    //                         product = await getSkuAcenda({clientId: process.env.acendaClientIdSS, clientSecret: process.env.acendaClientSecretSS, organization: process.env.acendaOrganizationSS, sku: item[0].group_skus[0] })
    //                     }
    ...
    //                             targeted_audience: p.blank.blank.category[0].toLowerCase() == "baby"? "Babies (0-24month)": p.blank.blank.department.toLowerCase() == "kids"? "kids (2-15)": "Adult (18 Years and Up)",
    ...
    //                             let item = await getSkuAcenda({clientId: process.env.acendaClientIdSS, clientSecret: process.env.acendaClientSecretSS, organization: process.env.acendaOrganizationSS, sku: v.sku })
