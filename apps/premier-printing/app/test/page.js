...
import {getOrderKohls, NextGTIN, CreateUpdateUPC, getTokenAcenda, getItemsWalmart, retireItemWalmart, getSpecWalmart, bulkUploadWalmart, getFeedWalmart, getWarehouseAcenda, getCatalogAcenda} from "@pythias/integrations"
...
export default async function Test(){
    ...
    // let item = await getCatalogAcenda({clientId: process.env.acendaClientIdSS, clientSecret: process.env.acendaClientSecretSS, organization: process.env.acendaOrganizationSS })
    // for(let i of item){
    //     console.log(i.group_skus, i.images)
    // }
