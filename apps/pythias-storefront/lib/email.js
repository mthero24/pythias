...
// Minimal, safe email shell. `brand` = the store name; `footerHtml` carries the unsubscribe link.
export function baseTemplate({ brand = "Our Store", title = "", contentHtml = "", footerHtml = "" }) {
