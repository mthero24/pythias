...
export async function POST(req) {
    ...
    const site = orgId ? await StorefrontSite.findOne({ orgId }).select("name customDomain subdomain businessInfo").lean() : null;
    ...
    const full = await baseTemplate({ brand, contentHtml, footerHtml: `${brand} · Preview` });
