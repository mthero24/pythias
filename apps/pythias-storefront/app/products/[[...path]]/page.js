...
async function resolveProductDoc(orgId, token) {
    ...
    const SELECT = "title description productImages variantsArray design designTemplateId slug sku blanks defaultColor category department salePercent trackInventory continueSellingOOS isCatalogProduct";
