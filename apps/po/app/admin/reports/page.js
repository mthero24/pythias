...
function estimateFee(order) {
    ...
    return (order.productCost || 0) * rate;
}
...
function CostsTab({ summary, byMarketplace, cogsByMarketplace, licenceFeeByMarketplace, ordersData, onPageChange, onPageSizeChange, onSortChange, sortField, sortDir, costItemsData, costItemsSortField, costItemsSortDir, onCostItemsPageChange, onCostItemsPageSizeChange, onCostItemsSortChange, inventoryValue, totalServiceCost = 0, totalKlingCost = 0 }) {
    const { orders, total, page, pageSize, loading } = ordersData;
                        ...
                        {summary.totalRevenue > 0 ? (
                            <PieChart
                                series={[{ data: [
                                    ...
                                    { id: 6, value: Math.max(0, net),        label: "Net",          color: "#4caf50" },
