...
export async function GET(request, { params }) {
    ...
    let height = (envelope.height / (item.design[side].includes("ai-design")? dimensions.height: 3500)) * dimensions.height;
    ...
    let xml = `<?xml version="1.0" encoding="utf-16"?>
        ...
        item.styleV2.code == "AS" || item.styleV2.code == "YLT" || (item.styleV2.code == "TK" && (item.sizeName == "L" || item.sizeName == "M"))  || (item.styleV2.code == "YT" && (item.sizeName == "S"))
                                        ? 2
        : item.styleV2.code == "AFTH" || (item.styleV2.code == "WVT" && (item.sizeName == "XL" || item.sizeName == "2XL" || item.sizeName == "3XL")) || (item.styleV2.code == "WT" && item.sizeName == "M")
                                        ? 3
                                        : 1
                                    }</MaterialThicknessInt>
