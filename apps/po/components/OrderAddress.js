...
export function OrderAddress({ order }) {
    ...
    const onChange = (field, value) => setAddress(prev => ({ ...prev, [field]: value }));
        ...
        <Card variant="outlined" sx={{ flex: 1, borderRadius: 2, overflow: "hidden" }}>
            ...
            <Box sx={{ p: 2 }}>
                <Grid2 container spacing={1.5}>
                    ...
                    <Grid2 size={{ xs: 12, sm: 6 }}>
                        <TextField size="small" label="Phone" fullWidth value={address?.phone ?? ""} onChange={(e) => onChange("phone", e.target.value)} />
                    </Grid2>
                    ...
                    <Grid2 size={{ xs: 4, sm: 3 }}>
                        <TextField size="small" label="ZIP" fullWidth value={address?.zip ?? ""} onChange={(e) => onChange("zip", e.target.value)} />
                    </Grid2>
                    <Grid2 size={{ xs: 4, sm: 3 }}>
