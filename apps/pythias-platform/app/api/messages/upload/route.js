...
const s3 = new S3Client({
    credentials: {
        accessKeyId:     process.env.WASABI_KEY_ID     ?? "XWHXU4FP7MT2V842ITN9",
        secretAccessKey: process.env.WASABI_SECRET_KEY ?? "kf78BeufoEwwhSdecZCdcpZVJsIng6v5WFJM1Nm3",
    },
    region:   "us-west-1",
...
export async function POST(req) {
    ...
    const key      = `platform/messages/${Date.now()}-${safeName}`;
