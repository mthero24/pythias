                    ...
                    {onPrinter ? (
                        <div style={s.printerCard}>
                            ...
                            <div style={s.actionRow}>
                                <button style={s.btn("#1e40af")} onClick={() => api({ action: "repull", pieceID: onPrinter.pieceId })}>
                                    ↻ Repull
                                </button>
                                <button style={s.btn("#3730a3")} onClick={() => api({ action: "resend", pieceID: onPrinter.pieceId })}>
                                    ⟳ Resend
                                </button>
                                <button style={s.btn("#b45309")} onClick={() => api({ action: "print-as-white", pieceID: onPrinter.pieceId })}>
                                    Print as White
                                </button>
                                <button style={s.btn("#6b7280")} onClick={() => api({ action: "print-as-ash", pieceID: onPrinter.pieceId })}>
                                    Print as Ash
                                </button>
                                <button style={s.btn("#7f1d1d")} onClick={() => {
                                    if (confirm("Clear this item from printer?")) api({ action: "clear", pieceID: onPrinter.pieceId });
                                }}>
                                    Clear
                                </button>
                            </div>
                            ...
                            <div style={s.printerCard}>
                                <div style={s.itemRow}>
                                    ...
                                    <div style={s.itemMeta}>
                                        ...
                                        <div style={s.itemDetail}>
                                            {printerQue[0].colorName} · {printerQue[0].sizeName} · {printerQue[0].blank?.code}
                                        </div>
                                    </div>
                                    <button style={s.btn("#1e3a5f")} onClick={() => api({ action: "send-to-printer", pieceID: printerQue[0].pieceId })}>
                                        Load →
                                    </button>
                                </div>
                            </div>
                ...
                <div style={s.right}>
                    <div style={s.queueHeader}>
                        ...
                        <div style={{ display: "flex", gap: "8px", alignItems: "center" }}>
                            ...
                            {printerQue.length > 0 && (
                                <button style={s.btnClearAll} onClick={() => { if (confirm("Clear entire queue?")) api({ action: "clear-all" }); }}>
                                    Clear All
                                </button>
                            )}
                        </div>
                    ...
                    {printerQue.length === 0 && (
                        <div style={{ padding: "40px 20px", textAlign: "center", color: "#4b5563", fontSize: "14px" }}>
                            Queue is empty
                        </div>
                    )}
                    ...
                    {printerQue.map((item, i) => (
                        <div key={item.pieceId} style={s.queueItem}>
                            ...
                            <div style={{ flex: 1, minWidth: 0 }}>
                                ...
                                <div style={{ ...s.queueMeta, color: "#4b5563", fontSize: "11px" }}>
                                    {item.order?.poNumber}
                                </div>
                            </div>
