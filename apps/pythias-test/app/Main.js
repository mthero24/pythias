...
const MARKETPLACES = [
    { src: target,  alt: "Target",         href: "https://www.target.com/s?searchTerm=simpy+sage+market" },
    { src: tsc,     alt: "Tractor Supply", href: "https://www.tractorsupply.com/tsc/brand/Simply+Sage+Market" },
    { src: shopify, alt: "Shopify",        href: "https://thejunipershopwholesale.com/" },
    { src: amazon,  alt: "Amazon",         href: "https://www.amazon.com/stores/SimplySageMarket/page/E2BCEA3C-F5F5-4C70-BFBB-B47E3901C7E8" },
    { src: faire,   alt: "Faire",          href: "https://www.faire.com/search?q=olive_and_ivory_wholesale" },
    { src: kohls,   alt: "Kohl's",         href: "https://www.kohls.com/search.jsp?search=simply+sage+market" },
    ...
    return (
        <Box sx={{ backgroundColor: "background.default", minHeight: "100vh" }}>
            ...
            <Box sx={{ py: 2.5, px: 3, mt: 1, display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 1 }}>
                <Typography variant="caption" color="text.disabled">© {new Date().getFullYear()} Pythias Technologies. All rights reserved.</Typography>
