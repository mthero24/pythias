...
export function NavigationProgress() {
    ...
    return (
        <>
            <style>{`
                @keyframes ptr-fade-in {
                    from { opacity: 0; }
                    to   { opacity: 1; }
                }
                @keyframes ptr-glisten {
                    0%   { left: -80%; }
                    100% { left: 140%; }
                }
                @keyframes ptr-pulse {
                ...
                .ptr-overlay {
                    ...
                    animation: ptr-fade-in 150ms ease forwards;
                }
                .ptr-logo-wrap {
                    position: relative;
                    display: inline-block;
                    animation: ptr-pulse 2.2s ease-in-out infinite;
                ...
                .ptr-glisten-beam {
                    ...
                    animation: ptr-glisten 2s cubic-bezier(0.4, 0, 0.6, 1) infinite;
                ...
                .ptr-bar-fill {
                    ...
                    animation: ptr-bar 2.8s cubic-bezier(0.1, 0.4, 0.3, 1) forwards;
                    border-radius: 0 2px 2px 0;
                }
            `}</style>

            <div className="ptr-overlay">
                <div className="ptr-logo-wrap">
                    <img
                        src="/logoPythias-400.png"
                        alt="Loading…"
                        className="ptr-logo"
                    />
                    <div className="ptr-glisten-wrap">
                        <div className="ptr-glisten-beam" />
                    </div>
                </div>
            </div>

            <div className="ptr-bar-track">
                <div className="ptr-bar-fill" />
            </div>
        </>
    );
}
