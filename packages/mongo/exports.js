...
export { default as EditLock } from "./models/EditLock";
...
export { default as PlatformProduct, computeProductFacets } from "./models/Products";
export { resolveVariantSize } from "./helpers/variantSize";
