                                ...
                                product.blanks.map(b => {
                                                ...
                                                for (let col of product.colors) {
                                                    if(b.images && b.images.length > 0){
                                                        for (let bm of b.images.filter(m => m.color.toString() == col._id.toString())) {
                                                            if(!im.filter(i => i.image == encodeURI(`https://platform.pythiastechnologies.com/api/renderImages/${design.sku}-${b.code.replace(/-/g, "_")}-${bm.image.split("/")[bm.image.split("/").length - 1].split(".")[0]}-${col.name.replace(/\//g, "_")}-${ti}-${tc.name}.jpg?width=400&orgSlug=${slug}`)).length > 0){
                                                                im.push({ image: encodeURI(`https://platform.pythiastechnologies.com/api/renderImages/${design.sku}-${b.code.replace(/-/g, "_")}-${bm.image.split("/")[bm.image.split("/").length - 1].split(".")[0]}-${col.name.replace(/\//g, "_")}-${ti}-${tc.name}.jpg?width=400&orgSlug=${slug}`), color: col, threadColor: tc, side: ti, blank: b, sku: `${design.printType}_${design.sku}_${col.sku}_${b.code.replace(/-/g, "_")}_${bm.image.split("/")[bm.image.split("/").length - 1].split(".")[0]}-${col.name.replace(/\//g, "_")}-${ti}-${tc.name}` })
                                                            }
                                            ...
                                            for (let col of product.colors) {
                                                if (b.images && b.images.length > 0) {
                                                    for (let bm of b.images.filter(m => m.color?.toString() == col._id?.toString() && (Object.keys(m.boxes ? m.boxes : {}).includes(ti) || Object.keys(m.boxes ? m.boxes : {}).includes("back")))) {
                                                        if (!im.filter(i => i.image == encodeURI(`https://platform.pythiastechnologies.com/api/renderImages/${design.sku}-${b.code.replace(/-/g, "_")}-${bm.image.split("/")[bm.image.split("/").length - 1].split(".")[0]}-${col.name.replace(/\//g, "_")}-${Object.keys(design.images ? design.images : {}).join("_") }.jpg?width=400&orgSlug=${slug}`)).length > 0 && Object.keys(bm.boxes ? bm.boxes : {}).includes(ti) && Object.keys(design.images ? design.images : {}).includes(ti)) {
                                                            im.push({ image: encodeURI(`https://platform.pythiastechnologies.com/api/renderImages/${design.sku}-${b.code.replace(/-/g, "_")}-${bm.image.split("/")[bm.image.split("/").length - 1].split(".")[0]}-${col.name.replace(/\//g, "_")}-${Object.keys(design.images ? design.images : {}).join("_") }.jpg?width=400&orgSlug=${slug}`), color: col, sides: Object.keys(design.images ? design.images : {}).join("_"), blank: b, sku: `${design.printType}_${design.sku}_${col.sku}_${b.code.replace(/-/g, "_")}_${bm.image.split("/")[bm.image.split("/").length - 1].split(".")[0]}-${col.name.replace(/\//g, "_")}-${ti}` })
                                                        }
                                                        if (!Object.keys(design.images ? design.images : {}).includes("back") && Object.keys(bm.boxes ? bm.boxes : {}).includes("back") && !im.filter(i => i.image == encodeURI(`https://platform.pythiastechnologies.com/api/renderImages/${design.sku}-${b.code.replace(/-/g, "_")}-${bm.image.split("/")[bm.image.split("/").length - 1].split(".")[0]}-${col.name.replace(/\//g, "_")}-back.jpg?width=400&orgSlug=${slug}`)).length > 0) {
                                                            console.log("________back___________")
                                                            im.push({ image: encodeURI(`https://platform.pythiastechnologies.com/api/renderImages/${design.sku}-${b.code.replace(/-/g, "_")}-${bm.image.split("/")[bm.image.split("/").length - 1].split(".")[0]}-${col.name.replace(/\//g, "_")}-back.jpg?width=400&orgSlug=${slug}`), color: col, sides: "back", blank: b, sku: `${design.printType}_${design.sku}_${col.sku}_${b.code.replace(/-/g, "_")}_${bm.image.split("/")[bm.image.split("/").length - 1].split(".")[0]}-${col.name.replace(/\//g, "_")}-back` })
                                                        }
                                                    }
                                                } else {
                                                    for (let bm of b.multiImages[ti].filter(m => m.color.toString() == col._id.toString() && m.imageGroup?.includes(product.imageGroup)).length > 0 ? b.multiImages[ti].filter(m => m.color.toString() == col._id.toString() && m.imageGroup?.includes(product.imageGroup)) : b.multiImages[ti].filter(m => m.color.toString() == col._id.toString() && m.imageGroup?.includes("default"))) {
                                    ...
                                    const pushBackFromImages = (col, urlSideSuffix, extra) => {
                                        ...
                                        for (const bm of b.images.filter(m => m.color?.toString() == col._id?.toString() && Object.keys(m.boxes ? m.boxes : {}).includes("back"))) {
                                            const fileBase = bm.image.split("/").pop().split(".")[0];
                                            const url = encodeURI(`https://platform.pythiastechnologies.com/api/renderImages/${design.sku}-${codeKey}-${fileBase}-${col.name.replace(/\//g, "_")}-${urlSideSuffix}.jpg?width=400&orgSlug=${slug}`);
